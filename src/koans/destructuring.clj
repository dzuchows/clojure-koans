...
(meditations
  ...
  (= (str "First comes love, "
    ...
    ((fn [[a b c]] (format (str "First comes %s, then comes %s, then comes %s with the baby carriage") a b c))
...
(println (str (apply str (interpose " " ["Test" "Testerson"])) ", " (apply str (interpose ", " (vals test-address)))))

  "All together now!"
  (= "Test Testerson, 123 Test Lane, Testerville, TX"
     (str (apply str(interpose " " ["Test" "Testerson"])) ", " (apply str(interpose ", " (vals test-address)))))
  )
